...
# run id: 2026_09_20t08_42_01_444254
...
( cd "aws-ebs/storage-generation" && cd "$(cs-image-system materialize . --root-dir "$CSIS_ROOT")" && cs-image-system apply-check --lifecycle storage --root aws-ebs --root-alias aws-east2-runtime )
...
( cd "aws-efs/storage-generation" && cd "$(cs-image-system materialize . --root-dir "$CSIS_ROOT")" && cs-image-system apply-check --lifecycle storage --root aws-efs --root-alias aws-east2-runtime )
...
( cd "aws-s3/storage-generation" && cd "$(cs-image-system materialize . --root-dir "$CSIS_ROOT")" && cs-image-system apply-check --lifecycle storage --root aws-s3 --root-alias aws-east2-runtime )
...
( cd "gcp-gcs/storage-generation" && cd "$(cs-image-system materialize . --root-dir "$CSIS_ROOT")" && cs-image-system apply-check --lifecycle storage --root gcp-gcs --root-alias gcloud-east1 )
...
( cd "gcp-pd/storage-generation" && cd "$(cs-image-system materialize . --root-dir "$CSIS_ROOT")" && cs-image-system apply-check --lifecycle storage --root gcp-pd --root-alias gcloud-east1 )
