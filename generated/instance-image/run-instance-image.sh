...
# run id: 2026_09_20t05_34_00_111083
...
( cd "open-tofu/instance-generation" && cd "$(cs-image-system materialize . --root-dir "$CSIS_ROOT")" && cs-image-system apply-check --lifecycle instances --root open-tofu --root-alias aws-east2-runtime )
